...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <aside id="default-sidebar"
            ...
            aria-label="Sidebar">
            <x-application-logo class="m-4 h-16 w-16 place-self-center fill-current text-gray-500 drop-shadow-lg" />
            <hr class="border-oldbrick dark:border-gray-700 w-4/5 place-self-center" />
        ...
        <header class="bg-oldbrick flex p-6 text-2xl text-white shadow-lg sm:ml-64">
            {{ $header }}
        </header>
